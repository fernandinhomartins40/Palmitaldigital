...
import { Home, Tag, PlusCircle, MessageCircle, User } from 'lucide-react';
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-sm border-t border-gray-100 safe-bottom shadow-[0_-1px_6px_rgba(0,0,0,0.06)]">
            ...
            >
              {primary ? (
                <div className="flex flex-col items-center gap-0.5">
                  <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center shadow-lg shadow-blue-200 -mt-4">
